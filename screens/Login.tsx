        ...
        <View style={styles.container}>
            ...
            <View style={[styles.layoutLogin, shadow]}>
                <View style={styles.form}>
                    ...
                    <TouchableOpacity style={styles.buttonLogin} activeOpacity={.7} onPress={() => {
                        navigation.navigate('Home')
                    }}>
                        <View >
                            <Text style={styles.buttonLoginTitle}>Đăng nhập</Text>
                        </View>
                    </TouchableOpacity>
            ...
            <View style={styles.textChange}>
                ...
                <TouchableOpacity activeOpacity={.7} onPress={
                    () => {
                        navigation.navigate('RegiterForm')
                    }
                } ><Text style={styles.textPress}> Đăng ký </Text></TouchableOpacity>
            </View>
